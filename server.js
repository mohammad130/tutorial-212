...
const app=express();
const pool=new pg({host:'ec2-3-222-150-253.compute-1.amazonaws.com',database:'d9ls5apmvj0gsj',user:'tujpifldakyleb',password:'707902ce8b19d34aa0231a0ff1f5836477d5579c052c92b0703b8645476f740d',port:'5432',ssl: { rejectUnauthorized: false } });
...
app.listen(_port, function () { console.log("Node Express server for " + app.name + " listening on http://localhost:" + _port); });